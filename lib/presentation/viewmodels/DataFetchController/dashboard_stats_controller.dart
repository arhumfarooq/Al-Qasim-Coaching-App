...
//   ever(attendanceController.attendanceDays, (_) {
//     calculateStats();
//   });

//   ever(testResultController.results, (_) {
//     calculateStats();
//   });

//   ever(feeController.fees, (_) {
//     calculateStats();
//   });
...
//             e.status.toLowerCase() == 'absent');
//   }).toList();

//   if (weekDays.isEmpty) return 0;

//   final present = weekDays
...
class DashboardStatsController extends GetxController {
  ...
  try {
    ...
    await attendanceController.fetchMonthlyAttendance();
    ...
    print('DASHBOARD ATTENDANCE DAYS: ${attendanceController.attendanceDays.length}');
    print('DASHBOARD ATTENDANCE VALUE: ${thisWeekAttendanceValue.value}');
  } finally {
    isLoading.value = false;
  }
}
  ...
  print('CALCULATED ATTENDANCE: ${thisWeekAttendanceValue.value}');
}
  ...
  double get thisWeekAttendance {
    ...
    final present = weekDays.where((e) {
